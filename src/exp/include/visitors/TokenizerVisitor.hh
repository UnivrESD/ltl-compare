...
/// @brief TokenizerVisitor generates a string given an expression.
class TokenizerVisitor : public ExpVisitor {
public:
  /// @brief if colored is true, the string will be colored.
  TokenizerVisitor(Language lang, bool colored, PrintMode mode);

  /// @brief Destructor.
  ~TokenizerVisitor() override = default;
